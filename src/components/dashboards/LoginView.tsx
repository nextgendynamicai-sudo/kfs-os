          ...
          {currentUser ? (
            ...
            <>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-8">
                ...
                <button onClick={() => setActiveTab("rider")} className={`flex-1 min-w-[80px] py-2.5 px-1 text-[10px] font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer border-none ${activeTab === "rider" ? "bg-violet-600 text-white shadow-md" : "bg-violet-50 text-violet-600 hover:text-violet-800"}`}>Nitro Rider</button>
