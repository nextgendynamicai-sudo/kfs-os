  ...
  return (
    <div className="min-h-screen bg-violet-50 text-violet-950 font-sans pb-24 relative">
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 bg-slate-950/80 backdrop-blur-2xl border-t border-violet-500/20 shadow-[0_-10px_40px_rgba(15,23,42,0.6)] py-3 px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-center gap-4 overflow-x-auto no-scrollbar py-1 px-2">
          {[
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center min-w-[80px] px-4 py-2.5 rounded-2xl cursor-pointer transition-all duration-300 border backdrop-blur-md flex-shrink-0 ${
                  isActive
