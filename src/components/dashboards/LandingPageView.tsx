  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fcfaff] via-[#f2e6ff] to-[#d8beff] text-violet-950 font-sans overflow-x-hidden selection:bg-violet-600 selection:text-white">
      ...
      <section className="relative pt-40 pb-20 px-6 sm:px-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 min-h-[90vh]">
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-violet-400/20 rounded-full blur-[120px] -z-10"></div>

        <div className="flex-1 space-y-8 z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/80 border border-violet-200 text-xs font-bold text-violet-600 uppercase tracking-widest backdrop-blur-md shadow-sm">
            <span className="w-2 h-2 rounded-full bg-violet-500 animate-pulse"></span>
            El Ecosistema Financiero Definitivo
          </div>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-black leading-[1.1] tracking-tight text-violet-950">
            Gobierna tu <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button onClick={() => setView("login")} className="bg-violet-600 text-white px-8 py-4 rounded-xl font-black text-lg hover:scale-105 active:scale-95 transition-all shadow-xl shadow-violet-600/30 cursor-pointer flex items-center justify-center gap-2 border-none">
              <Zap size={20} /> Empezar Ahora
            </button>
            <button onClick={() => {
              const el = document.getElementById("pricing");
              el?.scrollIntoView({ behavior: 'smooth' });
            }} className="bg-white border border-violet-100 shadow-md text-violet-900 px-8 py-4 rounded-xl font-bold text-lg transition-all cursor-pointer flex items-center justify-center gap-2 hover:shadow-lg hover:-translate-y-1">
        ...
        <div className="flex-1 w-full relative z-10">
          <div className="bg-white rounded-[2rem] p-4 shadow-2xl shadow-violet-200/50 border border-violet-50 transition-transform duration-700 ease-out">
      ...
      <section id="benefits" className="py-20 px-6 sm:px-10 max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-violet-950">Todo lo que necesitas, <span className="text-violet-600">sin licencias extra</span>.</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Benefit 1 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">Nitro Market (E-Commerce)</h3>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">Sincro-Shield Fiscal (SENIAT)</h3>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">Auto-Conciliación SMS</h3>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">Bóveda Criptográfica</h3>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">Instalación PWA Móvil</h3>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-8 rounded-[2rem] hover:shadow-2xl hover:shadow-violet-200/50 hover:-translate-y-2 transition-all group">
            ...
            <h3 className="text-xl font-black mb-3 text-violet-950">CRM & Fidelización Express</h3>
      ...
      <section id="pricing" className="py-20 px-6 sm:px-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16 mb-16">
          <h2 className="text-4xl md:text-6xl font-black text-violet-950 tracking-tighter mb-6">Planes Escalamiento</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
          {/* Plan 1 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 rounded-[2.5rem] p-8 flex flex-col justify-between hover:shadow-2xl hover:-translate-y-2 transition-all relative">
            <div>
              <h3 className="text-2xl font-black text-violet-950">Flow Velocity</h3>
              <p className="text-sm text-slate-500 mt-2">Perfecto para negocios pequeños empezando a digitalizarse.</p>

              <div className="my-8">
                <span className="text-5xl font-black text-violet-950">3%</span>
              ...
              <ul className="space-y-3 pt-6 text-sm text-slate-600">
                ...
                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-violet-600" /> {KFS_BRAND.modules.marketplace} PWA Personalizada</li>
            ...
            <button onClick={() => setView("login")} className="w-full bg-violet-50 text-violet-700 font-bold py-4 rounded-xl mt-8 cursor-pointer transition-colors hover:bg-violet-100 border-none">Empezar</button>
          </div>

          {/* Plan 2 (Popular) */}
          <div className="bg-gradient-to-br from-white to-violet-50 shadow-2xl shadow-violet-200/50 border-2 border-violet-300 rounded-[2.5rem] p-8 flex flex-col justify-between hover:-translate-y-4 transition-all relative transform md:-translate-y-2">
            ...
            <div>
              <h3 className="text-2xl font-black text-violet-950">Flow Matrix AI</h3>
            ...
            <button onClick={() => setView("login")} className="w-full bg-violet-600 text-white shadow-lg shadow-violet-600/30 font-black py-4 rounded-xl mt-8 cursor-pointer hover:scale-[1.02] active:scale-95 transition-transform border-none">Suscribirme</button>
          </div>
          ...
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 rounded-[2.5rem] p-8 flex flex-col justify-between hover:shadow-2xl hover:-translate-y-2 transition-all relative">
            <div>
              ...
              <h3 className="text-2xl font-black text-violet-950">Flow Monopoly OS</h3>
              <p className="text-sm text-slate-500 mt-2">El ecosistema financiero corporativo total para grandes franquicias.</p>

              <div className="my-8">
                <span className="text-5xl font-black text-violet-950">10%</span>
      ...
      <section className="py-20 px-6 sm:px-10 max-w-7xl mx-auto border-t border-violet-100 bg-white/30 backdrop-blur-md rounded-[3rem]">
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-violet-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1: Outreach */}
          <div className="bg-white border border-violet-100 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] hover:border-violet-300 transition-colors">
            ...
            <h4 className="font-black text-xl text-violet-950 mb-3">Outreach Automatizado (Cada 4 Días)</h4>
          ...
          <div className="bg-white border border-violet-100 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] hover:border-violet-300 transition-colors">
            <div className="w-12 h-12 bg-violet-50 rounded-xl flex items-center justify-center mb-6">
              <ShoppingCart className="text-violet-500" size={24} />
            </div>
            <h4 className="font-black text-xl text-violet-950 mb-3">Optimización del {KFS_BRAND.modules.marketplace}</h4>
            <p className="text-sm text-slate-500 leading-relaxed">
          ...
          <div className="bg-white border border-violet-100 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] hover:border-violet-300 transition-colors">
            ...
            <h4 className="font-black text-xl text-violet-950 mb-3">Buscador de Clientes en Redes</h4>
            <p className="text-sm text-slate-500 leading-relaxed">
      ...
      <section className="py-20 px-6 sm:px-10 max-w-7xl mx-auto border-t border-violet-100">
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-100 border border-violet-200 text-xs font-black text-violet-600 uppercase tracking-widest">
            <span className="w-2 h-2 rounded-full bg-violet-600 animate-pulse"></span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-violet-950">¿Qué son los Axis Points y cómo benefician a tu negocio?</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <h4 className="font-bold text-violet-950 text-base">Axis Nitro Hubs</h4>
              ...
              <div className="space-y-2">
                ...
                <h4 className="font-bold text-violet-950 text-base">Tecnología Sin Comisiones</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <h4 className="font-bold text-violet-950 text-base">Fidelización Instantánea</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <h4 className="font-bold text-violet-950 text-base">Conciliación Directa</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
      ...
      <section className="py-20 px-6 sm:px-10 max-w-7xl mx-auto border-t border-violet-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {/* Card 1: Setup Fee */}
          <div className="bg-white border border-violet-50 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] relative overflow-hidden">
            <h4 className="font-black text-lg text-violet-950 mb-2">Cuota de Setup (Instalación)</h4>
            <div className="text-4xl font-black text-violet-600 my-4">$75 USD <span className="text-xs text-slate-400 font-normal">pago único</span></div>
          ...
          <div className="bg-white border border-violet-50 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] relative overflow-hidden">
            <h4 className="font-black text-lg text-violet-950 mb-2">Mantenimiento Mensual Nube</h4>
            <div className="text-4xl font-black text-violet-600 my-4">$6 USD <span className="text-xs text-slate-400 font-normal">al mes</span></div>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
          ...
          {/* Card 3: Royalties */}
          <div className="bg-white border border-violet-50 shadow-xl shadow-violet-100/50 p-8 rounded-[2rem] relative overflow-hidden">
            <h4 className="font-black text-lg text-violet-950 mb-2">Regalías de Venta (Comisiones)</h4>
            <div className="text-4xl font-black text-violet-600 my-4">3% / 5% / 10% <span className="text-xs text-slate-400 font-normal">por venta real</span></div>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
      ...
      <section className="py-20 px-6 sm:px-10 max-w-7xl mx-auto border-t border-violet-100 bg-white/40 backdrop-blur-md rounded-[3rem] shadow-xl shadow-violet-100/30 mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="bg-white/20 backdrop-blur-sm border border-violet-100 rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-between hover:border-violet-300 transition-all">
            <div className="space-y-6">
              ...
              <div className="space-y-4 border-t border-violet-200 pt-6">
                <h4 className="font-bold text-violet-700 text-sm uppercase tracking-wider">Ahorro Garantizado:</h4>
            ...
            <div className="pt-8">
              <button
                ...
                className="w-full sm:w-auto bg-violet-600 text-white px-8 py-4 rounded-xl font-black text-sm hover:scale-[1.02] active:scale-95 transition-transform shadow-lg shadow-violet-600/30 cursor-pointer border-none"
              >
          ...
          <div className="bg-violet-600 border border-violet-500 rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-between hover:border-violet-400 transition-all relative overflow-hidden">
            <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-white/10 rounded-full blur-[80px] -z-10"></div>

            <div className="space-y-6">
              <span className="text-violet-100 text-xs font-black uppercase tracking-widest block">Para Promotoras de Expansión</span>
              ...
              <div className="space-y-4 border-t border-violet-500 pt-6">
                <h4 className="font-bold text-white text-sm uppercase tracking-wider">Tus Beneficios y Labores:</h4>
                <ul className="space-y-3 text-xs text-violet-50">
                  <li className="flex items-start gap-2">
      ...
      <section id="process" className="py-20 px-6 sm:px-10 max-w-7xl mx-auto border-t border-violet-100">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-violet-950">Proceso de Activación Rápida</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Step 1 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-6 rounded-[2rem] relative hover:-translate-y-1 transition-transform">
            <span className="text-6xl font-black text-violet-100 absolute right-6 top-6">01</span>
            <h4 className="font-black text-lg text-violet-950 mb-2 relative z-10">Registro de Cuenta</h4>
          ...
          {/* Step 2 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-6 rounded-[2rem] relative hover:-translate-y-1 transition-transform">
            <span className="text-6xl font-black text-violet-100 absolute right-6 top-6">02</span>
            <h4 className="font-black text-lg text-violet-950 mb-2 relative z-10">Configurar Bóveda</h4>
          ...
          {/* Step 3 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-6 rounded-[2rem] relative hover:-translate-y-1 transition-transform">
            <span className="text-6xl font-black text-violet-100 absolute right-6 top-6">03</span>
            <h4 className="font-black text-lg text-violet-950 mb-2 relative z-10">Subir Productos</h4>
          ...
          {/* Step 4 */}
          <div className="bg-white shadow-xl shadow-violet-100/50 border border-violet-50 p-6 rounded-[2rem] relative hover:-translate-y-1 transition-transform">
            <span className="text-6xl font-black text-violet-100 absolute right-6 top-6">04</span>
            <h4 className="font-black text-lg text-violet-950 mb-2 relative z-10">Cobrar y Vender</h4>
