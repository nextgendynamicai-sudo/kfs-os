    ...
    <ModalPortal>
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-12 h-12 rounded-full bg-violet-600/10 flex items-center justify-center border border-violet-200">
        ...
        <div className="space-y-6 relative z-10">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-500 uppercase tracking-widest flex items-center gap-2">
              <DollarSign size={14} className="text-violet-600"/> Monto a Retirar ({currency})
            </label>
            <input 
              type="number" 
            ...
            {parsedAmount > 0 && (
              <div className="flex justify-between items-center text-[10px] text-slate-500 mt-1 px-1 font-mono">
                ...
                <span>Total a Debitar: <strong className="text-violet-950">{formatMoney(totalToDeduct)}</strong></span>
              </div>
            )}
          ...
          <div className="bg-indigo-900/20 p-4 rounded-xl border border-violet-500/20 flex gap-3">
